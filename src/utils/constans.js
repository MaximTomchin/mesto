...
export const openChangeAvatarPopupButton = document.querySelector('.profile__change-avatar-button');
...
export const popupChange = document.querySelector('.popup_type_change-avatar');
...
export const popupChangeAvatar = document.querySelector('.popup__container_type_change-avatar');
...
export const avatarInput = popupChange.querySelector('.popup__field');
