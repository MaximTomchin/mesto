...
export const errorProfileName = popup.querySelector('.error_type_name');
export const errorProfileAbout = popup.querySelector('.error_type_about');
export const errorCardTitle = popupAdd.querySelector('.error_type_title');
export const errorCardLink = popupAdd.querySelector('.error_type_link');
